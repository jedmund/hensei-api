...
RSpec.describe GridDamage::GridComposition do
  describe ".summarize" do
    it "tallies weapon types, per-id copies, distinct skill types, and omega-skill count" do
      entries = [
        { proficiency: 1, granblue_id: "A", modifiers: %w[Might Enmity], omega: false },
        { proficiency: 1, granblue_id: "A", modifiers: %w[Might], omega: true },
        { proficiency: 2, granblue_id: "B", modifiers: %w[Stamina], omega: false }
      ]
