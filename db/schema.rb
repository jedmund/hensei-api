...
ActiveRecord::Schema[8.0].define(version: 20_250_301_143_956) do
  ...
  create_table 'grid_characters', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[party_id position], name: 'index_grid_characters_on_party_id_and_position'
  ...
  create_table 'grid_summons', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[party_id position], name: 'index_grid_summons_on_party_id_and_position'
  ...
  create_table 'grid_weapons', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[party_id position], name: 'index_grid_weapons_on_party_id_and_position'
  ...
  create_table 'parties', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[visibility created_at], name: 'index_parties_on_visibility_created_at'
    t.index %w[weapons_count characters_count summons_count], name: 'index_parties_on_counters'
  end
